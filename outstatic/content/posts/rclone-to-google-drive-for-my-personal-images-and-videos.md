...
> 
> <your app name> has not completed the Google verification process. The app is currently being tested, and can only be accessed by developer-approved *testers*. If you think you should have access, contact the developer.
...
To list the contents of the a directory <dir> or subdirectoy <sub\_dir>.

### 4\. It's time to "copy" your folders/images to Drive!

```javascript
rclone copy --update --verbose "usr/dir/subdir" "your_remote:/dir"
```
